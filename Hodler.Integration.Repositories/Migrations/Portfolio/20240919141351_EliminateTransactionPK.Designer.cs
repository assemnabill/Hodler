...
namespace Hodler.Integration.Repositories.Migrations.Portfolio
{
    ...
    [Migration("20240919141351_EliminateTransactionPK")]
    partial class EliminateTransactionPK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hodler.Integration.Repositories.Portfolio.Entities.Transaction", b =>
                {
                    ...
                    b.HasKey("PortfolioId", "Timestamp", "Type", "BtcAmount", "FiatAmount", "FiatCurrency", "MarketPrice", "CryptoExchange");
